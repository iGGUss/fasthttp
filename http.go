...
func (req *Request) BodyUnzstdWithMaxOutputSize(maxOutputSize int) ([]byte, error) {
	return unzstdData(req.Body(), maxOutputSize)
}
...
func (req *Request) BodyUncompressedWithMaxOutputSize(maxOutputSize int) ([]byte, error) {
	...
	case "zstd":
		return req.BodyUnzstdWithMaxOutputSize(maxOutputSize)
	default:
		return nil, ErrContentEncodingUnsupported
	}
}
